...
function define (mongoose, fn) {
    ...
    */
    ...
    Comment.virtual('gravatar').get(function () {
        return utils.gravatar(this.email, { s: 32, d: 'identicon' });
    });

    Comment.virtual('bodyParsed').get(function () {
        return mdParser(utils.convertMarkup(this.body),
            true, 'a|br|pre|strong|blockquote', {
                'a': 'href|title|target',
                'blockquote': 'cite',
                'pre': 'class'
            }
    ...
    Note.virtual('bodyParsed').get(function(){
        ...
        return mdParser(utils.convertMarkup(this.body), true,
